            ...
            <div className="p-8">
              ...
              <div className="space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-blue-600 text-white py-3 px-6 rounded-md hover:bg-blue-800  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors duration-200"
                >
                  Submit Quiz
                </button>
              </div>
